...
void TNvStorage::Erase(unsigned addr, unsigned len)
{
  if (!initialized)
  {
    return;
...
void TNvStorage::Write(unsigned addr, void * src, unsigned len)
{
  if (!initialized)
  {
    return;
...
void TNvStorage::CopyTo(unsigned addr, void * src, unsigned len)
{
  if (!initialized)
  {
    return;
...
void TNvStorage::Read(unsigned addr, void * dst, unsigned len)
{
  if (!initialized)
  {
    return;
